...
Source0  : https://www.kernel.org/pub/software/utils/dtc/dtc-1.5.1.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567639973
...
cp README.license %{buildroot}/usr/share/package-licenses/dtc/README.license
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libfdt-1.5.0.so
/usr/lib64/libfdt.so
/usr/lib64/libfdt.so.1

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/dtc/README.license
